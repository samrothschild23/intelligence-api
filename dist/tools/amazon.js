...
export async function searchAmazon(keyword, marketplace = "US") {
...
function estimateFBA(price, rating, reviewCount) {
    ...
    const tier = profitMargin > 30 ? "high"
...
export async function getAmazonProduct(asin, marketplace = "US") {
    const domain = MARKETPLACE_DOMAINS[marketplace.toUpperCase()] ?? MARKETPLACE_DOMAINS.US;
