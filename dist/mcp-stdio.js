...
const server = new Server({ name: "intelligence-api", version: "1.0.0" }, { capabilities: { tools: {} } });
// ─── Tool definitions ────────────────────────────────────────────────────────
server.setRequestHandler(ListToolsRequestSchema, async () => ({
    tools: [
        {
            name: "shopify_analyze",
            description: "Analyze any Shopify store — products, pricing distribution, top vendors, detected apps (Klaviyo, Yotpo, etc.), theme, and collections.",
            inputSchema: {
                type: "object",
                properties: {
                    url: {
        ...
        },
        {
            ...
            description: "Fetch a paginated product catalog from any Shopify store. Up to 250 products per call.",
            inputSchema: {
                type: "object",
                properties: {
                    url: {
        ...
        {
            name: "amazon_search",
            description: "Search Amazon products by keyword. Returns an Opportunity Score (0–100) for each result based on demand, rating gap, and price.",
            inputSchema: {
                type: "object",
                properties: {
                    keyword: {
        ...
        {
            name: "amazon_product",
            description: "Deep analysis of a single Amazon product by ASIN. Includes FBA fee estimate, profit margin, and opportunity tier.",
            inputSchema: {
                type: "object",
                properties: {
                    asin: {
        ...
        {
            name: "maps_search",
            description: "Search Google Maps businesses by type and location. Returns each business with a Lead Quality Score (0–100) and outreach hints.",
            inputSchema: {
                type: "object",
                properties: {
                    query: {
        ...
        {
            name: "maps_leads",
            description: "Find qualified sales leads on Google Maps filtered by Lead Quality Score. Best for building targeted outreach lists.",
            inputSchema: {
                type: "object",
                properties: {
                    industry: {
