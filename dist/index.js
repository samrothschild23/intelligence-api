...
function buildOpenAPISpec() {
    return {
        ...
        info: {
            ...
            version: "1.0.0",
            description: "E-commerce and business intelligence API. Analyze Shopify stores, Amazon products, and find sales leads from Google Maps. All endpoints require x402 USDC micropayment on Base.",
        },
        servers: [{ url: "/" }],
        paths: {
            "/shopify/analyze": {
                get: {
                    ...
                    description: "Returns products, collections, pricing stats, detected apps and theme. **$0.08 USDC via x402**",
                    parameters: [
                        {
                            name: "url",
                            in: "query",
            ...
            "/shopify/products": {
                get: {
                    ...
                    description: "Returns paginated products from any Shopify store. **$0.02 USDC via x402**",
                    parameters: [
                        {
                            name: "url",
                            in: "query",
            ...
            "/amazon/search": {
                get: {
                    ...
                    description: "Search Amazon for products with Opportunity Score. **$0.05 USDC via x402**",
                    parameters: [
                        {
                            name: "keyword",
                            in: "query",
            ...
            "/amazon/product": {
                get: {
                    ...
                    description: "Full product analysis with FBA profitability estimate. **$0.08 USDC via x402**",
                    parameters: [
                        {
                            name: "asin",
                            in: "query",
            ...
            "/maps/search": {
                get: {
                    ...
                    description: "Business search with Lead Quality Score. Requires your Google Places API key. **$0.05 USDC via x402**",
                    parameters: [
                        {
                            name: "query",
                            in: "query",
            ...
            "/maps/leads": {
                get: {
                    ...
                    description: "Returns leads above a quality score threshold with outreach hints. **$0.10 USDC via x402**",
                    parameters: [
                        {
                            name: "industry",
                            in: "query",
